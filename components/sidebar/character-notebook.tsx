...
interface CharacterNotebookProps {
  ...
  loadedAnalysisData?: Character[]
}

export interface CharacterNotebookRef {
  getAnalysisData: () => Character[] | null
}
...
export const CharacterNotebook = forwardRef<CharacterNotebookRef, CharacterNotebookProps>(
  ({ content, onCharacterNameChange, loadedAnalysisData }, ref) => {
    ...
    useEffect(() => {
      if (loadedAnalysisData && loadedAnalysisData.length > 0) {
        setCharacters(loadedAnalysisData)
      }
    }, [loadedAnalysisData])

    // Expose character data through ref
    useImperativeHandle(ref, () => ({
      getAnalysisData: () => characters.length > 0 ? characters : null
    }))
      ...
      <div className="flex flex-col h-full p-4">
        ...
        <div className="flex-1 min-h-0">
          {loading ? (
            ...
            <div className="h-full overflow-y-auto border-2 border-gray-300 rounded-lg bg-gray-50 p-3 shadow-inner">
